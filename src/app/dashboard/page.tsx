...
type TabType = 'people' | 'messages' | 'groups' | 'history' | 'search' | 'settings'
          ...
          {activeTab === 'groups' && (
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-cyan-500 to-cyan-600 text-white py-3 px-4 rounded-xl font-semibold hover:opacity-90 transition-opacity flex items-center justify-center gap-2"
              >
              ...
              <div className="bg-slate-800/50 backdrop-blur border border-slate-700/30 rounded-2xl p-4">
                ...
                {groups.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-500 text-xs mt-1">Create a group to start chatting!</p>
                  </div>
                ) : (
                    ...
                    {groups.map(group => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {group.description && (
                            <p className="text-gray-400 text-sm truncate">{group.description}</p>
                          )}
                        </div>
                        {group.role === 'admin' && (
      ...
      {openGroupId && (
        <GroupChat
          ...
          onStartCall={(callId, callType) => {
            console.log('Group call started:', callId, callType)
          }}
        />
      )}
